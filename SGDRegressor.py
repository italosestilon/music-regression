...
class SGDRegressor:
        ...
        def fit(self, X, y, Y_test):
                ...
                self._perform_gradient_descendent_with_sklearn(X, y,Y_test)
        ...
        def _perform_gradient_descendent_with_sklearn(self, X, Y, Y_test):
                ...
                for epoch in range(self.max_iter):
                        ...
                        self.train_erros.append(mean_squared_error(y_train_predict, Y_test)) 
